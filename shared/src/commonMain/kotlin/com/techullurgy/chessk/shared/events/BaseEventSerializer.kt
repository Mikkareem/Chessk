...
val clientToServerBaseEventJson = Json {
...
val serverToClientBaseEventJson = Json {
    serializersModule = SerializersModule {
        ...
        polymorphic(ServerToClientBaseEvent::class, SelectionResult::class, SelectionResult.serializer())
        polymorphic(ServerToClientBaseEvent::class, ResetSelectionDone::class, ResetSelectionDone.serializer())
    }
}